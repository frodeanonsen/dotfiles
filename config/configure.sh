...
then
	...
	git clone https://github.com/frodeanonsen/dotfiles.git ~/.dotfiles
	echo ''
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with macOS dotfiles..."
    else
        echo "macOS dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply macOS dotfiles. You will need to configure your environment manually..."
	echo ''
